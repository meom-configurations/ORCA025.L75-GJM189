...
CONTAINS
   ...
   SUBROUTINE wnd_cyc( kt, pwnd_i, pwnd_j )
      ...
      REAL(wp), DIMENSION(:,:), POINTER ::   zwnd_x, zwnd_y   ! zonal and meridional components of the wind
      ...
      !      NAMELIST/namsbc_tc/ cn_dir , sn_tc
      !!--------------------------------------------------------------------

      CALL wrk_alloc( jpi,jpj, zwnd_x, zwnd_y )
      ...
      CALL wrk_dealloc( jpi,jpj, zwnd_x, zwnd_y )
